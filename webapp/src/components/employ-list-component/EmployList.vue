<template>
  <div>
    ...
    <div class="columns is-multiline">
      ...
      <div v-for="(item, index) in items" :key="index">
        <Employ
          ...
          v-on:updateList="updateEmployList"
          v-on:openEditEmploy="toggleModal"
          v-bind:id="item.id"
          v-bind:name="item.name"
          v-bind:cargo="item.cargo"
        ></Employ>
      </div>
    </div>
    ...
    <ModalRegister
      ...
      v-bind:id="this.employ.id? this.employ.id : ''"
      v-bind:employName="this.employ.name"
      v-bind:employCargo="this.employ.cargo"
      v-if="openModal"
    ></ModalRegister>
  </div>
</template>
